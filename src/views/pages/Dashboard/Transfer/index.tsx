                ...
                <div className="form-transfer">
                    <form onSubmit={transfer}>
                        ...
                        <input value={valuer} onChange={e => setValuer(e.target.value)} type="number"
                               placeholder="Qual o valor de sua transferência?"></input>
                        ...
                        {
                            type === "841" &&
                            <input value={recipient} onChange={e => setRecipient(e.target.value)} type="text"
                                   placeholder="Login do destinatário"></input>
